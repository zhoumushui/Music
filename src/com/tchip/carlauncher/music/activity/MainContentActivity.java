...
import com.tchip.carlauncher.music.fragment.MenuFragment;
import com.tchip.carlauncher.music.slidemenu.SlidingMenu;
import com.tchip.carlauncher.music.utils.MusicUtils;
import com.tchip.carlauncher.music.utils.SplashScreen;
...
public class MainContentActivity extends FragmentActivity implements IConstants {
	...
	private void setSleepClock(String timeS) {
		...
		Toast.makeText(getApplicationContext(), "将在" + timeS + "分钟后退出软件",
				Toast.LENGTH_SHORT).show();
	}
