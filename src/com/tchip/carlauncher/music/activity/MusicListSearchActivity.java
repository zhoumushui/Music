package com.tchip.carlauncher.music.activity;
...
import com.tchip.carlauncher.music.utils.StringHelper;
import com.tchip.carlauncher.music.view.KeyBoardKeyView;
...
public class MusicListSearchActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAnimIn = AnimationUtils.loadAnimation(this, R.anim.music_push_bottom_in);
		mAnimOut = AnimationUtils.loadAnimation(this, R.anim.music_push_bottom_out);
	...
	private void initConnection() {
		...
		Intent intent = new Intent("com.tchip.carlauncher.music.service.MediaService");
